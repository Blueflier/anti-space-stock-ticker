...
async function widgetUI(anti) {
    ...
    return ((0, jsx_runtime_1.jsxs)(sdk_1.components.Column, { children: [(0, jsx_runtime_1.jsx)(sdk_1.components.Text, { type: "heading1", children: "Hello, Antispace!" }), (0, jsx_runtime_1.jsx)(sdk_1.components.Input, { name: "nickname", placeholder: "Type something..." }), (0, jsx_runtime_1.jsx)(sdk_1.components.Button, { action: "setNickname", text: "Set Nickname" })] }));
}
