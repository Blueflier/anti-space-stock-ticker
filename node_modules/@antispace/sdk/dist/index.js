...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@base2+pretty-print-object@1.0.1/node_modules/@base2/pretty-print-object/dist/index.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/react-element-to-jsx-string@15.0.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/react-element-to-jsx-string/dist/cjs/index.js
var require_cjs = __commonJS({
  "../../node_modules/.pnpm/react-element-to-jsx-string@15.0.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/react-element-to-jsx-string/dist/cjs/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var KV = class {
   ...
   */
  constructor(token, integrationId) {
    this.token = token || process.env.ANTISPACE_PLATFORM_TOKEN || "";
    this.baseUrl = "https://anti.space/api/kv";
    if (integrationId) {
      this.integrationId = integrationId;
    } else {
      this.integrationId = process.env.ANTISPACE_APP_ID;
    }
    if (!this.integrationId) {
      throw new Error('[Antispace KV Error]: No App ID provided. Pass an App ID to KV constructor or ensure anti.json in the root directory of your project contains an "appId" property.');
    }
    if (!this.token) {
      console.warn("No platform token provided for KV. Please provide a token or set the ANTISPACE_PLATFORM_TOKEN environment variable.");
    }
  }
  /**
  ...
  async get(key) {
    if (!this.integrationId) {
      throw new Error("App ID for KV not provided");
    }
    const response = await fetch(`${this.baseUrl}/${encodeURIComponent(this.integrationId)}/${encodeURIComponent(key)}`, {
      method: "GET",
      headers: {
  ...
  async update(key, value) {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.errors?.join(", ") || `Failed to update key: ${key} (${response.status})`);
    }
    return {
      key,
      value
  ...
  async delete(key) {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.errors?.join(", ") || `Failed to delete key: ${key} (${response.status})`);
    }
...
// src/renderer.ts
var import_react_element_to_jsx_string = __toESM(require_cjs());
...
function renderUI(element) {
  return (0, import_react_element_to_jsx_string.default)(element, {
    functionValue: () => {
      throw new RendererError("Functions are not supported in mods");
    }
  });
}
